...
import 'package:fluttermdb/responsive/mobile_screen_layout.dart';
  ...
  if (kIsWeb) {
    await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: 'AIzaSyC86N4MuiCYUP8ZpihsoL1V9fQz76w7HDc',
        appId: '1:144842041483:web:5de6c1d87c3bfbbe044c8e',
        messagingSenderId: '144842041483',
        projectId: 'fluttermdb',
        storageBucket: 'fluttermdb.appspot.com',
      ),
    );
  } else {
    await Firebase.initializeApp();
